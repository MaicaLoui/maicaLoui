    ...
    <div class="col-4">
      ...
      <table class="table table-bordered justify-content-center">
        ...
        <tbody>
          ...
          <tr>
            <th  class="text-center" scope="row"><h4>1 - 3</h4></th>
            <td  class="text-center"> <h4><span class="badge bg-primary rounded-pill">  {{ $skirtPattern['oneToThree'] }}</span></h4></td>
            <td  class="text-center"><h4><i class="bi bi-arrow-down"></h4></i></td>         
          </tr>
          <tr>
            <th class="text-center" scope="row"><h4>1 - 2</h4></th>
            <td  class="text-center"> <h4><span class="text-center badge bg-primary rounded-pill" >{{ $skirtPattern['oneToTwo'] }}</span></h4></td>
            <td  class="text-center"><h4><i class=" text-center bi bi-arrow-down"> </h4></i></td>
          </tr>
          <tr>
            <th  class="text-center" scope="row"><h4>1 - 4</h4></th>
            <td  class="text-center"> <h4><span class="badge bg-primary rounded-pill">{{ $skirtPattern['oneToFour'] }}</span></h4></td>
            <td  class="text-center"><h4><i class="bi bi-arrow-left"></h4></i></td>         
          </tr>
          <tr>
            <th  class="text-center" scope="row"><h4>1 - 7</h4></th>
            <td  class="text-center"> <h4><span class="badge bg-primary rounded-pill">{{ $skirtPattern['oneToSeven'] }}</span></h4></td>
            <td  class="text-center"><h4><i class="bi bi-arrow-left"></h4></i></td>         
          </tr>
        </tbody>
